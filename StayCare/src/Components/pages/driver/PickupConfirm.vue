<template>
  <div class="space-y-6 max-w-2xl">
    ...
    <div class="flex items-center gap-3">
      <button @click="navStore.goBack('route')" class="text-gray-400 hover:text-gray-600">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
      </button>
      <h2 class="text-lg font-semibold text-gray-800">Confirm Pickup</h2>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 space-y-4">
          ...
          <div>
            ...
            <div class="border-2 border-dashed border-gray-200 rounded-lg p-6 text-center">
              ...
              <p class="text-xs text-gray-400">Tap to capture photo of bags</p>
            </div>
          </div>
